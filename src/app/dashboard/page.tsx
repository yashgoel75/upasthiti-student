...
const generateMockData = (): MockData => {
  const semesterSubjects: { [key: number]: Subject[] } = {
    1: [
      { id: 'SUB001', name: 'Programming Fundamentals', code: 'CS101', credits: 4 },
      ...
      { id: 'SUB005', name: 'English Communication', code: 'EN101', credits: 2 },
    ],
    2: [
      { id: 'SUB006', name: 'Object Oriented Programming', code: 'CS201', credits: 4 },
      { id: 'SUB007', name: 'Discrete Mathematics', code: 'MA201', credits: 3 },
      { id: 'SUB008', name: 'Data Structures', code: 'CS202', credits: 4 },
      { id: 'SUB009', name: 'Computer Organization', code: 'CS203', credits: 3 },
      { id: 'SUB010', name: 'Environmental Science', code: 'ES201', credits: 2 },
    ],
    3: [
      { id: 'SUB011', name: 'Database Management Systems', code: 'CS301', credits: 4 },
      ...
      { id: 'SUB015', name: 'Theory of Computation', code: 'CS305', credits: 3 },
    ],
  };
...
const StudentDashboard: FC = () => {
  ...
  const handleSubjectClick = (subjectData: SubjectAttendanceWithStats): void => {
    ...
    return (
      <div className="min-h-screen bg-red-100 flex items-center justify-center">
        <p className="text-red-700 font-semibold">
          Error: Data for selected semester (Semester {selectedSemester}) not found.
        </p>
      </div>
    );
  }

  const currentSemesterAttendance = calculateSemesterAttendance(currentSemester);
